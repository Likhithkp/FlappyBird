...
SCREEN = pygame.display.set_mode((420, 630))  # Setting the display
...
def display_obstacle(height):
    ...
    bottom_obstacle_height = 600 - height - 150
    pygame.draw.rect(SCREEN, OBSTACLE_COLOR, (obstacle_x, 600, OBSTACLE_WIDTH, -bottom_obstacle_height))
...
def score_display(score):
    display = SCORE_FONT.render(f"Score: {score}", True, (200, 200, 200))
    SCREEN.blit(display, (7, 7))
...
def start():
    ...
    display = startFont.render(f"PRESS SPACE BAR TO START", True, (200, 200, 200))
    SCREEN.blit(display, (20, 150))
...
game_over_font1 = pygame.font.Font('freesansbold.ttf', 30)
...
def game_over():
    ...
    #  "game over"
    display1 = game_over_font1.render(f"GAME OVER", True, (200, 30, 30))
    ...
    SCREEN.blit(display2, (50, 350))
    #  If your new score is the same as the maximum then u reached a new high score
    if score == maximum:
        display3 = game_over_font2.render(f"NEW HIGH SCORE!!", True, (200, 30, 30))
